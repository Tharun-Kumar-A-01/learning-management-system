        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-[#1a1a1a] rounded-xl border border-[#2a2a2a] p-6 text-center">
              <div className="w-12 h-12 mx-auto mb-4 bg-[#5f82f3]/10 rounded-lg flex items-center justify-center">
                <svg className="w-6 h-6 text-[#5f82f3]" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
